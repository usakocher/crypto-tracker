            ...
            <div className={classes.mainTable}>
                <table className={classes.table}>
                    ...
                    <tr className={classes.tableRow}>
                        <td className={classes.logo}><a href="https://www.coinbase.com/" target="blank"><img src={coinbase} alt="logo"></img></a></td>
                    ...
                    <tr className={classes.tableRow}>
                        <td className={classes.logo}><a href="https://www.binance.com/en" target="blank"><img src={binance} alt="logo"></img></a></td>
                    ...
                    <tr className={classes.tableRow}>
                        <td className={classes.logo}><a href="https://www.kraken.com/en-us/" target="blank"><img src={kraken} alt="logo"></img></a></td>
                    ...
                    <tr className={classes.tableRow}>
                        <td className={classes.logo}><a href="https://cex.io/" target="blank"><img src={cexio} alt="logo"></img></a></td>
                    ...
                    <tr className={classes.tableRow}>
                        <td className={classes.logo}><a href="https://www.gemini.com/" target="blank"><img src={gemini} alt="logo"></img></a></td>
                    ...
                    <tr className={classes.tableRow}>
                        <td className={classes.logo}><a href="https://bittrex.com/" target="blank"><img src={bittrex} alt="logo"></img></a></td>
